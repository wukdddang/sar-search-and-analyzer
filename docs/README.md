...
- [15. 프론트엔드 아키텍처](./15-frontend-architecture.md) — OpenLayers·Next.js·plan/current 분리·폴더 구조
- [16. 프론트엔드 유즈케이스](./16-frontend-usecases.md) — UC 코드 표 (user/admin/공통)
- [17. 프론트엔드 IA](./17-frontend-ia.md) — Screen ID 체계 (Page/Layer, CRUD 코드, 정책)
- [18. InSAR 산출물 대비 설계](./18-insar-products.md) — DInSAR/SBAS/PSInSAR 도입 대비 스키마·API·UI 초안
- [19. 프론트엔드 E2E 시나리오](./19-frontend-scenarios.md) — SC-USR-xxx / SC-ADM-xxx 흐름과 매트릭스
- [20. VWorld API 통합](./20-vworld-integration.md) — 주소→지번(PNU)→필지 폴리곤 조회 (SHP 업로드 대체)
